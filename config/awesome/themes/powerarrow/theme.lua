...
pathToConfig = os.getenv('HOME') .. "/.config/awesome/themes/powerarrow/"
...
theme.arr_to_orange = pathToConfig .. "icons/arr_to_orange.png"

-- The clock icon:
theme.clock = pathToConfig .. "icons/myclocknew.png"

--{{ For the wifi widget icons }} --
theme.net                    = pathToConfig .. "icons/net.png"
...
theme.battery                = pathToConfig .. "icons/battery.png"
theme.battery_low            = pathToConfig .. "icons/battery_low.png"
theme.battery_empty          = pathToConfig .. "icons/battery_empty.png"

--{{ For the hard drive icon }} --
theme.fsicon = pathToConfig .. "icons/hdd.png"

--{{ For the pomodoro icon }} --
theme.pomodoro = pathToConfig .. "icons/pomodoro.png"

--{{ For the music icons }} --
-- theme.mute = pathToConfig .. "icons/mute.png"
-- theme.music = pathToConfig .. "icons/music.png"
theme.widget_music                  = pathToConfig .. "icons/note.png"
theme.widget_music_on               = pathToConfig .. "icons/note_on.png"
...
--{{ For the temperature }}
theme.widget_temp                   = pathToConfig .. "icons/temp.png"
